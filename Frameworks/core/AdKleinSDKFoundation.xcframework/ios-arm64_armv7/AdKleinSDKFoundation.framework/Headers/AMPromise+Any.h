...
@interface AMPromise<Value>(AnyAdditions)
 ...
 */
+ (AMPromise<NSArray *> *)any:(NSArray *)promises NS_SWIFT_UNAVAILABLE("");
...
/**
 Convenience dot-syntax wrappers for `AMPromise` `any` operators.
 Usage: AMPromise.any(@[ ... ])
 */
@interface AMPromise<Value>(DotSyntax_AnyAdditions)

+ (AMPromise<NSArray *> * (^)(NSArray *))any AM_PROMISES_DOT_SYNTAX NS_SWIFT_UNAVAILABLE("");
+ (AMPromise<NSArray *> * (^)(dispatch_queue_t, NSArray *))anyOn AM_PROMISES_DOT_SYNTAX
